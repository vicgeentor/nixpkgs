...
For configuration options not directly exposed by the module, use [extraConfig](#opt-services.tdarr.server.extraConfig) for server configuration and per-node extraConfig or global [extraNodeConfig](#opt-services.tdarr.extraNodeConfig):
